...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ !empty($data->id) ? "แก้ไข" : "เพิ่ม" }}พนักงาน</div>
                    ...
                    <form method="POST" action="{{ url('staff') }}" enctype="multipart/form-data">
                      @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control{{ $errors->has('password') }}" name="password" required>
